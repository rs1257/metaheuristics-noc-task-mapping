...
def populate_topology(grid_size):
    ...
    positions = list(itertools.product(range(0, grid_size[0]), range(0, grid_size[1])))
...
def communication_latency(taskset, grid):
    ...
    for t in sorted_tasks:
        ...
        while result != last:
            ...
            interference = 0
            for i in interf:
                if common_link(t.get_core(), t.get_dest_core(), i.get_core(), i.get_dest_core(), grid):
                    if i.get_period() > 0:
